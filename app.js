...
function updateDashboard() {
    ...
    // Ensure streaks and water are tracked per day correctly
    ...
    // Steps are no longer random. Handled through manual app logs or OCR.
    ...
    animateRing('ring-steps-progress', Math.min((stepCount / 10000) * 100, 100));
    ...
    // Update Dashboard Water Level
    const waterEl = document.getElementById('dash-water-val');
    if (waterEl) waterEl.textContent = waterLvl + ' ml';
...
function initProfileActions() {
    document.getElementById('profile-avatar-trigger').onclick = () => document.getElementById('profile-img-input').click();
